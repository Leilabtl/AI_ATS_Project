...
class ReportGenerator:
    ...
    def generate_pdf_report(self, results, job_description, longlist_count=None, shortlist_count=None):
        ...
        # Title
        story.append(Paragraph("🤖 ELITE ATS - COMPREHENSIVE CANDIDATE REPORT", title_style))
    ...
    def categorize_by_thresholds(self, results, shortlist_threshold=70, longlist_threshold=50):
        """Categorize candidates by score thresholds instead of ranking."""
        ...
        for result in sorted_results:
            ...
            elif result['final_score'] >= longlist_threshold:
...
ELITE ATS System"""
            ...
            subject = "Application Status Update - ELITE ATS"
            body = f"""Dear Candidate,
...
ELITE ATS System"""
            ...
            subject = "Application Status - ELITE ATS"
            body = f"""Dear Candidate,
...
ELITE ATS System"""
    ...
    def generate_detailed_candidate_report(self, result):
        ...
        report.append(f"Generated by: ELITE ATS System\n")
